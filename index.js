...
const hiddenCodeArray = Array.from(hiddenCode);

const filteredCodeArray = hiddenCodeArray.filter(char => char !== 'X' && parseInt(char) % 2 !== 0);

const revealedCode = filteredCodeArray.join('');
